...
fn warn_player(omegga: &Omegga, target: impl ToString) {
    omegga.whisper(target.to_string(), "<size=\"30\"><color=\"a00\">Microbricks are not allowed on this server!</> Please delete your microbricks or <b>your bricks will be cleared</>.</>");
}
